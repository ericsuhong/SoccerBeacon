...
public class FieldView extends View 
{
	...
	protected void onDraw(Canvas canvas) {
		...
		if (fieldWidth != -1 && fieldHeight != -1)
		{
	        ...
	        paint.setColor(Color.parseColor(fieldColor));
	                       
	       canvas.drawRect(((bitmapWidth-2*margin)-adjustedFieldWidth)/2+margin, ((bitmapHeight-2*margin)-adjustedFieldHeight)/2+margin, adjustedFieldWidth + ((bitmapWidth-2*margin)-adjustedFieldWidth)/2+margin, adjustedFieldHeight+((bitmapHeight-2*margin)-adjustedFieldHeight)/2+margin, paint);
		   ...
		   paint.setColor(Color.parseColor(beaconColor));	    		   
	       ...
	       if (beaconLocationsList != null)
	       {
	    	   for (int i = 0 ; i < beaconLocationsList.size(); i++)
	    	   {
	    		   ...
	    		   canvas.drawCircle(((bitmapWidth-2*margin)-adjustedFieldWidth)/2 + x + margin, ((bitmapHeight-2*margin)-adjustedFieldHeight)/2+ y + margin, beaconRadius, paint);
	    	   }	       
	       }
		}
    }
